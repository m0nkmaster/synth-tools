...
SCHEMA:
{
  "synthesis": {
    "layers": [{
      ...
      "fm": { "carrier": number ${range(b.fm.carrier, 'Hz')}, "modulator": number ${range(b.fm.modulator, 'Hz')}, "modulationIndex": number ${range(b.fm.modulationIndex)} (0-10=subtle, 10-30=electric piano, 30-60=bells, 60+=harsh) },
